      ...
      {!user ? (
        <div className="container mx-auto px-4 py-8">
          <Card className="bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-center">Welcome to ZeroCodeCEO Dashboard</CardTitle>
              <CardDescription className="text-center">
                Log in to access all features and start building your web app today
              </CardDescription>
            </CardHeader>
