      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex flex-col items-center text-center px-4 mt-20">
          <div className="inline-flex items-center gap-2 bg-purple-100 px-4 py-1 rounded-full mb-6 animate-fade-in">
            ...
            <span className="text-sm">We&apos;ve made our dashboard with financials and statistics public. Check it out!</span>
          </div>
          ...
          <div className="animate-fade-in animation-delay-400 flex items-center gap-4 mb-8">
